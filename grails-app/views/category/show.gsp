			...
			<ol class="property-list category">
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="category.name.label" default="Name" /></span>
						...
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${categoryInstance}" field="name"/><ul>
							<g:entryList category="${categoryInstance?.name}"/>
						</ul>
						</span>
